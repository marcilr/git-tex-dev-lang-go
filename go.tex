...
\\
\\
Alternatively, \href{https://godoc.org/github.com/go-sql-driver/mysql\#Config.FormatDSN}{Config.FormatDSN} can be used to create a DSN string by filling a struct.
